...
export const projects: Project[] = [
  ...
  {
    id:          "prepgenie",
    title:       "PrepGenie — AI Exam Prep Platform",
  ...
  {
    id:          "healthconvat",
    title:       "Faforlife — Health Supplement Store",
    description: "A 15-product e-commerce platform for a Nigerian health supplement brand. Built with a centralized product data layer, EmailJS-powered order pipeline with branded email templates, WhatsApp deep-link CTA, and CI/CD via GitHub Actions and Vercel.",
    image:       "/images/projects/healthconvat.webp",
    tags:        ["Next.js 14", "TypeScript", "Tailwind CSS", "EmailJS", "Docker", "Vercel"],
    demoUrl:     "https://healthconvat.com/",
    caseStudy:   false,
  },
  {
    id:          "sparkle-press",
